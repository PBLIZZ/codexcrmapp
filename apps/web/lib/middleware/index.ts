// Export middleware from trpc.ts (auth middleware is now centralized there)
...
export const createApiMiddleware = () => [loggerMiddleware, errorHandlerMiddleware, sanitizeInput];
