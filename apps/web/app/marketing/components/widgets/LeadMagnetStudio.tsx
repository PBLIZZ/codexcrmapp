      ...
      <div className="space-y-6">
        <div className="bg-amber-50 dark:bg-amber-950/20 p-6 rounded-lg">
          ...
          <p className="text-muted-foreground mb-6">
            Create valuable downloadable resources that attract new clients and grow your email list. 
            Our AI-powered tools help you design professional lead magnets that convert visitors into leads.
          </p>
      ...
      <div className="space-y-6">
        <Card className="border-amber-100 dark:border-amber-900/50 py-0">
          ...
          <CardFooter className="flex justify-between border-t pt-4 pb-6">
            <Button variant="outline" size="sm" asChild>
              <Link href={{ pathname: "/marketing/lead-magnets/templates" }}>
                Browse Templates
              </Link>
            </Button>
            <Button variant="outline" size="sm" className="bg-amber-50 hover:bg-amber-100 dark:bg-amber-950/20 dark:hover:bg-amber-900/30" asChild>
        ...
        <div className="bg-purple-50 dark:bg-purple-950/20 p-4 rounded-lg">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Ready to convert leads into loyal clients? Our Membership & Loyalty tools help you create compelling membership programs and loyalty incentives.
          </p>
          <Button variant="link" className="text-purple-600 dark:text-purple-400 p-0 h-auto mt-2" onClick={() => document.querySelector('[value="membership"]')?.dispatchEvent(new MouseEvent('click'))}>
