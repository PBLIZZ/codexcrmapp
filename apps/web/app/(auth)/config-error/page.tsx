 ...
 */
export default function ConfigErrorPage({ searchParams }: { searchParams?: { missing?: string } }) {
        ...
        <CardContent className='space-y-4'>
          <div className='text-center space-y-2'>
            ...
            <p className='text-sm text-gray-600'>
              This is likely due to missing environment variables for the Supabase authentication
              service. Please contact the administrator to resolve this issue.
            </p>
            ...
            <div className='mt-4 p-4 bg-amber-50 border border-amber-200 rounded-md'>
              ...
              <p className='text-xs text-amber-700 mb-2'>
                {missingVar ? (
                  <>
                    The <code className='bg-amber-100 px-1 rounded'>{missingVar}</code> environment
                    variable is missing.
                  </>
                ) : (
              ...
              <p className='text-xs text-amber-700 mt-2'>
                Check your <code className='bg-amber-100 px-1 rounded'>.env.local</code> file or
