        ...
        <CardContent className="space-y-4">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-gray-600">
              This is likely due to missing environment variables for the
              Supabase authentication service. Please contact the administrator
            ...
            <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-md">
              ...
              <p className="text-xs text-amber-700 mb-2">
                {missingVar ? (
                  ...
                  <>
                    Ensure that the following environment variables are properly
                    set:
                  </>
                )}
              </p>
              ...
              <p className="text-xs text-amber-700 mt-2">
                ...
                file or deployment environment configuration.
              </p>
            </div>
          </div>
        </CardContent>
