...
import { AvatarImage } from '@codexcrm/ui';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export type NameSortField = 'full_name';
...
export function ContactList({
  ...
  onSortChange = () => {},
  onNameSortChange = () => {},
  nameSortField = 'full_name',
  dateFilterPeriod = 'all',
  onDateFilterChange = () => {},
  selectedSourceFilters = [],
  onSourceFilterChange = () => {},
}: ContactListProps) {
  // Query groups for contact group management - currently unused but kept for future group functionality
            ...
            >
              <DropdownMenu>
                ...
                <DropdownMenuContent align='start' className='w-48'>
                  <DropdownMenuItem onClick={() => onNameSortChange('full_name', 'asc')}>
                    <div className='flex items-center justify-between w-full'>
                      <span>Full Name (A-Z)</span>
                      {nameSortField === 'full_name' && sortDirection === 'asc' && (
                        <ArrowUp className='h-3 w-3' />
                      )}
                    </div>
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onNameSortChange('full_name', 'desc')}>
                    <div className='flex items-center justify-between w-full'>
                      <span>Full Name (Z-A)</span>
                      {nameSortField === 'full_name' && sortDirection === 'desc' && (
                        <ArrowDown className='h-3 w-3' />
                      )}
                    </div>
                  </DropdownMenuItem>
