    ...
    <Sidebar collapsible='icon' {...props}>
      ...
      <SidebarContent className=''>
        ...
        <SidebarGroup className=''>
          <SidebarGroupLabel className=''>Marketing Tools</SidebarGroupLabel>
          <SidebarMenu className=''>
            ...
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/marketing/content' }}
            ...
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/marketing/website' }}
                  className='flex items-center w-full'
                >
        ...
        {/* Content Creation */}
        <SidebarGroup className=''>
          <SidebarGroupLabel className=''>Create Content</SidebarGroupLabel>
          <SidebarMenu className=''>
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
        ...
        {/* Active Campaigns */}
        <SidebarGroup className=''>
          <SidebarGroupLabel className=''>Active Campaigns</SidebarGroupLabel>
          <SidebarMenu className=''>
            {mockCampaigns.slice(0, 3).map((campaign) => (
              <SidebarMenuItem key={campaign.id} className=''>
        ...
        <SidebarGroup className=''>
          <SidebarGroupLabel className=''>Wellness Templates</SidebarGroupLabel>
          <SidebarMenu className=''>
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
        ...
        <SidebarGroup className=''>
          ...
          <SidebarMenu className=''>
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/marketing/settings' }}
                  className='flex items-center w-full'
                >
