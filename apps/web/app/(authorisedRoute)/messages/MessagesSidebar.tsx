    ...
    <Sidebar collapsible='icon' {...props}>
      ...
      <SidebarContent className=''>
        ...
        <SidebarGroup className=''>
          <SidebarGroupLabel className=''>Messages</SidebarGroupLabel>
          <SidebarMenu className=''>
            ...
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/messages/archived' }}
        ...
        <SidebarGroup className=''>
          ...
          <SidebarMenu className=''>
            ...
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/messages/broadcast' }}
                  className='flex items-center w-full'
                >
            ...
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/messages/schedule' }}
                  className='flex items-center w-full'
                >
        ...
        <SidebarGroup className=''>
          <SidebarGroupLabel className=''>Recent Conversations</SidebarGroupLabel>
          <SidebarMenu className=''>
            {mockThreads.map((thread) => (
              <SidebarMenuItem key={thread.id} className=''>
                <SidebarMenuButton asChild className='h-auto p-2' tooltip='View Conversation'>
                  <Link
        ...
        <SidebarGroup className=''>
          ...
          <SidebarMenu className=''>
            <SidebarMenuItem className=''>
              <SidebarMenuButton asChild tooltip='Navigate' className=''>
                <Link
                  href={{ pathname: '/messages/settings' }}
                  className='flex items-center w-full'
                >
