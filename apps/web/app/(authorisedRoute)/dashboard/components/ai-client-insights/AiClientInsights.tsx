  ...
  return (
    <Card className={className}>
      <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
        <div>
          <CardTitle className='text-sm font-medium'>AI Client Insights</CardTitle>
          <CardDescription className='text-xs text-muted-foreground'>
            AI-generated insights about your clients
          </CardDescription>
        </div>
        <Button
          variant='ghost'
        ...
        <Carousel className='w-full'>
          <CarouselContent className='w-full'>
            {insights.map((insight) => (
              <CarouselItem key={insight.id} className='p-0'>
                <Card className='w-full'>
                  ...
                  <CardContent className='pb-4'>
                    ...
                    <Button size='sm' variant='link' className='mt-2 h-8 p-0 text-primary' asChild>
