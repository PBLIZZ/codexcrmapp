 ...
 */
export const Timeline = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(function Timeline(
...
export const TimelineItem = React.forwardRef<HTMLDivElement, TimelineItemProps>(function TimelineItem(
 ...
 */
export const TimelineSeparator = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(function TimelineSeparator(
  { className, children, ...props }, ref
) {
  return (
    <div
 ...
 */
export const TimelineContent = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(function TimelineContent(
  { className, children, ...props }, ref
) {
  return (
