    ...
    <div className={cn('space-y-8', className)} {...props}>
        ...
        <div className="p-4 bg-muted/30 rounded-lg">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Device: {isMobile ? 'Mobile' : 'Desktop'} | Hover:{' '}
                {hasHover ? 'Supported' : 'Not supported'}
              </p>
            </div>
            <button
              onClick={toggleTheme}
      ...
      <section>
        ...
        <Container className="mb-4 p-4 border border-dashed border-border rounded-lg">
          <p className="text-center text-sm text-muted-foreground">
            Container (max-width adapts to breakpoint)
          </p>
        </Container>
      ...
      <section>
        ...
        >
          <GridItem colSpan={{ xs: 12, md: 6 }}>
            <ContactCard
              ...
              actions={
                <div
                  className={responsiveClasses('flex', {
                    xs: 'flex-row',
                    md: 'flex-col',
                  })}
                >
        ...
        <TaskList
          layout="grid"
          columns={
            getResponsiveValue({ xs: 1, md: 2, lg: 3 }, 2) as 1 | 2 | 3 | 4
          }
          gap="md"
          className="mb-6"
          tasks={[
            {
              ...
              description:
                'Implement new metrics and charts for the wellness tracking dashboard',
              priority: 'high',
              status: 'in-progress',
              progress: 60,
            ...
            },
            {
              ...
              description:
                'Resolve issues with the mobile navigation menu on small screens',
              priority: 'medium',
              status: 'todo',
        ...
        >
          <TimelineItem active>
            ...
            >
              <p className="text-sm">
                Created repository and set up development environment
              </p>
            </TimelineContent>
          </TimelineItem>
          <TimelineItem active>
      ...
      <section className="p-4 bg-muted/30 rounded-lg">
        ...
        <p className="text-sm mb-2">
          This demo showcases the following responsive design patterns:
        </p>
