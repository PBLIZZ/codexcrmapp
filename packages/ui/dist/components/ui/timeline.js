...
export const Timeline = forwardRef(({ className, orientation = 'vertical', compact = false, reverse = false, children, ...props }, ref) => {
    ...
    return (_jsx("div", { ref: ref, className: cn(orientationClasses[orientation], orientation === 'vertical' ? spacingClasses : horizontalSpacingClasses, reverse && orientation === 'vertical' && 'flex-col-reverse', reverse && orientation === 'horizontal' && 'flex-row-reverse', className), ...props, children: children }));
});
Timeline.displayName = 'Timeline';
export const TimelineItem = forwardRef(({ className, icon, iconBackground, connector = true, connectorColor, connectorStyle = 'solid', active = false, orientation = 'vertical', position = 'left', children, ...props }, ref) => {
    ...
    if (orientation === 'vertical') {
        return (_jsxs("div", { ref: ref, className: cn('relative flex', className), ...props, children: [_jsxs("div", { className: "flex flex-col items-center mr-4", children: [_jsx("div", { className: cn('z-10 flex items-center justify-center w-8 h-8 rounded-full', active ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'), style: iconBackground ? { backgroundColor: iconBackground } : {}, children: icon || (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "m12 8 4 4-4 4" }), _jsx("path", { d: "m8 12h8" })] })) }), connector && (_jsx("div", { className: cn('w-0 h-full border-l-2 mt-1', connectorStyleClasses[connectorStyle]), style: {
                                borderColor: active
    ...
    return (_jsxs("div", { ref: ref, className: cn('relative flex flex-col', className), ...props, children: [_jsxs("div", { className: "flex items-center mb-2", children: [_jsx("div", { className: cn('z-10 flex items-center justify-center w-8 h-8 rounded-full', active ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'), style: iconBackground ? { backgroundColor: iconBackground } : {}, children: icon || (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "m12 8 4 4-4 4" }), _jsx("path", { d: "m8 12h8" })] })) }), connector && (_jsx("div", { className: cn('h-0 flex-1 border-t-2 ml-1', connectorStyleClasses[connectorStyle]), style: {
                            borderColor: active
                                ? connectorColor || activeConnectorColor
                                : connectorColor || defaultConnectorColor,
...
export const TimelineDot = forwardRef(({ className, size = 'md', color, variant = 'filled', active = false, ...props }, ref) => {
    ...
    return (_jsx("div", { ref: ref, className: cn('rounded-full', sizeClasses[size], variant === 'outlined' ? 'border-2' : '', active ? 'bg-primary border-primary' : 'bg-muted border-muted', className), style: color ? { backgroundColor: variant === 'filled' ? color : 'transparent', borderColor: color } : {}, ...props }));
});
