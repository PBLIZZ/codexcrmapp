...
var Timeline = React2.forwardRef(function Timeline2({ className, children, ...props }, ref) {
  return /* @__PURE__ */ jsxs5(
    "div",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx13("span", { className: "absolute left-0 top-0 h-full w-px bg-border" }),
        children
      ]
    }
  );
});
var TimelineItem = React2.forwardRef(function TimelineItem2({ className, icon, children, ...props }, ref) {
  return /* @__PURE__ */ jsxs5("div", { ref, className: cn("relative flex items-start gap-3", className), ...props, children: [
    /* @__PURE__ */ jsx13(TimelineSeparator, { children: icon }),
    /* @__PURE__ */ jsx13(TimelineContent, { children })
  ] });
});
var TimelineSeparator = React2.forwardRef(function TimelineSeparator2({ className, children, ...props }, ref) {
  return /* @__PURE__ */ jsx13(
    "div",
    {
      ...
      ...props,
      children: children ?? /* @__PURE__ */ jsx13("span", { className: "h-1.5 w-1.5 rounded-full bg-primary" })
    }
  );
});
var TimelineContent = React2.forwardRef(function TimelineContent2({ className, children, ...props }, ref) {
  return /* @__PURE__ */ jsx13("div", { ref, className: cn("flex flex-col gap-1", className), ...props, children });
});
...
function ThemeProvider({ children, ...props }) {
  return /* @__PURE__ */ jsx14(NextThemesProvider, { ...props, children });
}
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsxs6(
    Button,
    {
      ...
      children: [
        /* @__PURE__ */ jsx15(Sun, { className: "h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" }),
        /* @__PURE__ */ jsx15(Moon, { className: "absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" }),
        /* @__PURE__ */ jsx15("span", { className: "sr-only", children: "Toggle theme" })
      ]
    }
  );
}
