 ...
 */
export const handleDbError = (error: any, operation: string): { error: true; message: string; details: any } => {
...
): Promise<T | { error: true; message: string; details: any }> => {
  try {
 ...
 */
export const isDbError = (result: any): result is { error: true; message: string; details: any } => {
 ...
 */
export const handleDbResult = <T>(result: T | { error: true; message: string; details: any }): T => {
  if (isDbError(result)) {
 ...
 */
export const formatQuery = (query: string, params: any[] = []): string => {
