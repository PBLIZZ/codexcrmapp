...
export const aiActionRouter = router({
    ...
    updateStatus: protectedProcedure
        ...
        try {
            const aiAction = await AiActionsRepository.updateAiActionStatus(input.actionId, input.status, input.feedback);
            return aiAction;
        }
        catch (error) {
    ...
    markImplemented: protectedProcedure
        ...
        try {
            const aiAction = await AiActionsRepository.markAiActionImplemented(input.actionId, input.feedback);
            return aiAction;
        }
        catch (error) {
